...
Thank you for your interest in contributing to Okkur DNS.  
This guide helps make contributing to Okkur DNS simple and efficient for everyone.

### First contribution

If you are starting out contributing to Okkur DNS, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/okkur/dns/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the Okkur DNS wants to achieve, please open up an issue first.
