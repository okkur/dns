...
You are not allowed to search for security vulnerabilities on any hosted service of Okkur DNS without the consent of the party hosting it.
Okkur DNS is open source software and can be installed for testing and security issues on your own infrastructure.
